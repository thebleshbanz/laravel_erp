...
--
-- Host: localhost
-- Generation Time: Jan 21, 2020 at 01:25 PM
...
INSERT INTO `customers` (`customer_id`, `customerName`, `contactLastName`, `contactFirstName`, `phone`, `addressLine1`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`) VALUES
...
INSERT INTO `employees` (`employee_id`, `lastName`, `firstName`, `extension`, `email`, `office_id`, `reportsTo`, `jobTitle`) VALUES
...
INSERT INTO `offices` (`office_id`, `city`, `phone`, `addressLine1`, `addressLine2`, `state`, `country`, `postalCode`, `territory`) VALUES
...
INSERT INTO `orderdetails` (`order_id`, `product_id`, `quantityOrdered`, `priceEach`, `orderLineNumber`) VALUES
...
INSERT INTO `orders` (`order_id`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customer_id`) VALUES
...
INSERT INTO `productlines` (`productLine_id`, `textDescription`, `htmlDescription`, `image`) VALUES
...
INSERT INTO `products` (`product_id`, `productName`, `productLine_id`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`) VALUES
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`customer_id`,`checkNumber`);
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employee_id`);

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employee_id`),
  ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`office_id`) REFERENCES `offices` (`office_id`);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`productLine_id`) REFERENCES `productlines` (`productLine_id`);
COMMIT;
